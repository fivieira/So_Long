...
/*   Updated: 2023/09/30 18:09:19 by fivieira         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	place_images_in_game(t_so_long *game)
{
	...
	game->exit = mlx_xpm_file_to_image(game->mlxpointer, "Images/trophy.xpm", &i, &j);
	game->collectible = mlx_xpm_file_to_image(game->mlxpointer, "Images/coin.xpm", &i, &j);
}
